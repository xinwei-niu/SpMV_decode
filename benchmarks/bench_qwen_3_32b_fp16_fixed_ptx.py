...
def load_qwen3_14b(
    ...
    *,
    ...
    Supported environment controls:
        ...
        HF_MODEL_ID=Qwen/Qwen3-32B or another HF repo id
    ...
    model_name = model_id or os.environ.get("HF_MODEL_ID", "Qwen/Qwen3-32B")
